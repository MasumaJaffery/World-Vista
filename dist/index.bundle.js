...
eval("const involvementApiEndpoint = 'https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/FjhFMUdws0lCxR3eXCdS/likes';\r\n\r\n// Function to update the like counter for a specific flag\r\nasync function updateLikeCounter(flagElement) {\r\n  const country = flagElement.dataset.country;\r\n  try {\r\n    const response = await fetch(`${involvementApiEndpoint}?item_id=${country}`);\r\n    const data = await response.json();\r\n    const likeCounter = flagElement.querySelector('.like-counter');\r\n    if (likeCounter) {\r\n      likeCounter.textContent = data.length;\r\n    } else {\r\n      console.error(`Error: Unable to find the like counter element for ${country}.`);\r\n    }\r\n  } catch (error) {\r\n    console.error('Error updating like counter:', error);\r\n  }\r\n}\r\n\r\n// Function to handle like button click\r\nasync function handleLikeClick(event) {\r\n  const flagElement = event.target.closest('.flag');\r\n  if (flagElement) {\r\n    await sendLikeRequest(flagElement);\r\n    await updateLikeCounter(flagElement);\r\n    console.log('Like added');\r\n  }\r\n}\r\n\r\n// Function to send a POST request to the Involvement API for a specific flag\r\nasync function sendLikeRequest(flagElement) {\r\n  const country = flagElement.dataset.country;\r\n  try {\r\n    await fetch(involvementApiEndpoint, {\r\n      method: 'POST',\r\n      headers: {\r\n        'Content-Type': 'application/json'\r\n      },\r\n      body: JSON.stringify({\r\n        item_id: country\r\n      })\r\n    });\r\n  } catch (error) {\r\n    console.error(`Error liking ${country}:`, error);\r\n  }\r\n}\r\n\r\n// Add click event listener to handle like button clicks\r\ndocument.addEventListener('click', handleLikeClick);\r\n\r\n// Update like counters for all flags on initial page load\r\nconst flagElements = document.querySelectorAll('.flag');\r\nflagElements.forEach(updateLikeCounter);\r\n\r\n\r\n\n\n//# sourceURL=webpack://module-capstone--2/./src/modules/likeitems.js?");
